...
class ForumController extends Controller
{
    ...
    public function questionStore(Request $request)
    {
        ...
        if (!Auth::id()) {
            $this->showToastrMessage('error', 'At first you are login first!');
        ...
        $this->showToastrMessage('success', 'Question created successfully.');
    ...
    public function forumPostCommentStore(Request $request)
    {
        ...
        $this->showToastrMessage('success', 'Forum Post Comment Created Successfully');
        return redirect()->back();
    }
