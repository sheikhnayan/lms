...
class BankController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $this->showToastrMessage('success', 'Bank Created Successful');
    ...
    public function status($id)
    {
        ...
        if ($bank) {
            ...
            $bank->save();
            $this->showToastrMessage('success', 'Status Updated Successful');
            return redirect()->back();
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $bank->status = $request->status;
        $bank->save();
        $this->showToastrMessage('success', 'Bank Updated Successful');
    ...
    public function delete($id)
    {
        $bank = Bank::find($id);
        $bank->delete();
        $this->showToastrMessage('success', 'Bank Deleted Successful');
        return redirect()->route('settings.bank.index');
    }
}
