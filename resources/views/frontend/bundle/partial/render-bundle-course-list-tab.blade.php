        ...
        <div class="card course-item courses-bundles-course-item radius-3 bg-white">
            <div class="course-img-wrap overflow-hidden">
                ...
                <div class="course-item-hover-btns position-absolute">
                    <span class="course-item-btn addToWishlist" data-course_id="{{ $bundleCourse->course_id }}" data-route="{{ route('student.addToWishlist') }}" title="Add to Wishlist">
                        <i data-feather="heart"></i>
                    </span>
                    <span class="course-item-btn addToCart" data-course_id="{{ $bundleCourse->course_id }}" data-route="{{ route('student.addToCart') }}" title="Add to Cart">
