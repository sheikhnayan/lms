        ...
        <div class="card course-item border-0 radius-3 bg-white">
            ...
            <div class="card-body">
                ...
                <div class="course-item-bottom">
                    <div class="instructor-bottom-item font-14 font-semi-bold text-uppercase mb-15">Courses: <span class="color-hover">{{ @$bundle->bundleCourses->count() }}</span></div>
                    <div class="instructor-bottom-item font-14 font-semi-bold text-uppercase">Price: <span class="color-hover">
