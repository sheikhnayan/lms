        ...
        <div class="row">
                ...
                <div class="blog-page-left-content">
                    ...
                    <div class="blog-item">
                        ...
                        <div class="blog-item-img-wrap overflow-hidden position-relative">
                            ...
                            <div class="blog-item-tag position-absolute text-uppercase font-12 font-semi-bold text-white bg-hover radius-3">{{ __(@$blog->category->name) }}</div>
                        </div>

                        <div class="blog-item-bottom-part">
                            <h3 class="card-title blog-title"><a href="{{ route('blog-details', $blog->slug) }}">{{ __($blog->title) }}</a></h3>
                            <p class="blog-author-name-publish-date font-13 font-medium color-gray text-uppercase">{{ __('By') }}: {{ $blog->user->name }} / {{ @$blog->created_at->format(' j  M, Y')  }}</p>
                            <p class="card-text blog-content">{!!  Str::limit($blog->details, 200) !!}</p>

                            <div class="blog-read-more-btn">
                                <a href="{{ route('blog-details', $blog->slug) }}" class="theme-btn font-15 ps-0 font-medium text-capitalize color-hover">{{ __('Read More') }} <i data-feather="arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- Blog Item End -->
            ...
            <div class="col-12 col-md-5 col-lg-4">
                <div class="blog-page-right-content bg-white">
                    ...
                    <div class="blog-sidebar-box">
                        <h6 class="blog-sidebar-box-title text-uppercase">{{ __('Recent Blogs') }}</h6>
                    ...
                    <div class="blog-sidebar-box">
                        <h6 class="blog-sidebar-box-title text-uppercase">{{ __('Categories') }}</h6>
                    ...
                    <div class="blog-sidebar-box">
                        <h6 class="blog-sidebar-box-title text-uppercase">{{ __('Tags') }}</h6>
