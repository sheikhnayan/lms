                        ...
                        <div class="blog-page-left-content">
                            ...
                            <div class="block-2">
                                <div class="share-article d-flex align-items-center">
                                    <div class="share-box color-gray font-12 text-uppercase me-4 font-medium">{{ __('Share') }}:</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="contact-sub-btn">
                                                <button type="button" class="theme-button theme-button1 theme-button3 text-uppercase submitComment">{{ __('Submit Now') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
