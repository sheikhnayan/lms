                                        ...
                                        <form action="{{route('student.save-profile', [$student->uuid])}}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mb-30">
                                                    ...
                                                    <input type="text" name="postal_code" value="{{$student->postal_code}}" class="form-control" placeholder="{{__('Postal Code')}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mb-30">
                                                    ...
                                                    <input type="text" name="address" value="{{$student->address}}" class="form-control" placeholder="{{ __('Type your address') }}">
