                    ...
                    <div class="col-12 col-md-12 col-lg-12 col-xl-7 col-xxl-8">
                         @if(@$lecture_type)
                            <!-- My Code Start -->
                                ...
                                <a class="edit-lecture-preview-show d-flex align-items-center justify-content-between color-heading font-medium font-16 mb-3" data-maxwidth="800px" target="_blank" href="#">
                                </a>
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="play-list">
                                                            ...
                                                            @forelse($lesson->lectures as  $lecture)
                                                                ...
                                                                <div
                                                                    class="play-list-item @if(checkStudentCourseView($course->id, $lecture->id)) watchFinishedCourse @elseif($lecture->id == @$lecture_id_check) watchContinuingCourse @endif d-flex align-items-center justify-content-between font-15">
