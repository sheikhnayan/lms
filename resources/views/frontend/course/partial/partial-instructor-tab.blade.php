        ...
        <div class="col-md-7 col-lg-12 col-xl-7 p-0">
            <div class="meet-your-instructor-left d-flex">
                <div class="meet-instructor-img-wrap flex-shrink-0">
                    <img src="{{ getImageFile(@$course->user->image_path) }}" alt="img">
                </div>
            ...
            <div class="meet-your-instructor-right">
                <div class="d-flex">
                    <div>
                        ...
                        <div class="meet-instructor-extra-info-item color-heading"><span class="iconify" data-icon="ph:student"></span>{{ @$total_instructor_students }} {{ __('Students') }}</div>
                    </div>
                    <div>
                        ...
                        <div class="meet-instructor-extra-info-item color-heading"><span class="iconify" data-icon="ph:monitor-light"></span>{{ @$course->instructor->courses->count() }} {{ __('Courses') }}</div>
                    </div>
                </div>
            </div>
        </div>
