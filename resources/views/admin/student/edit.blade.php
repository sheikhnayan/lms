                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="postal_code" value="{{ $student->postal_code }}" placeholder="Postal Code" class="form-control"
                                               required>
                                ...
                                <div class="col-md-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <select name="gender" id="gender" class="form-select" required>
                                            ...
                                            <option value="Others" {{ $student->gender == 'Others' ? 'selected' : '' }} >{{ __('Others') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="input__group mb-25">
                                        ...
                                        <textarea name="about_me" id="" cols="15" rows="5" required>{{ $student->about_me }}</textarea>
