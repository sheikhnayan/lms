                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="professional_title" value="{{old('professional_title')}}" placeholder="{{__('Professional Title')}}" class="form-control"
                                           required>
                            ...
                            <div class="col-md-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="social_link[facebook]" value="" placeholder="https://facebook.com"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
