                ...
                <form action="{{ route('admin.forum.category.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="input__group mb-30">
                            ...
                            <input type="text" name="title" id="title" placeholder="Type title" value="" required>
                            @if ($errors->has('title'))
                        ...
                        <div class="input__group mb-30">
                            ...
                            <input type="text" name="subtitle" id="subtitle" placeholder="Type title" value="" required>
