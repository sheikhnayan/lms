...
@section('content')
    <div class="instructor-profile-right-part">
        ...
        <div class="instructor-create-new-quiz-page instructor-create-assignment-page bg-white">
            ...
            <div class="row">
                <div class="col-12">
                    <form class="create-new-quiz-form" action="{{ route('instructor.bundle-course.update', $bundle->uuid)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="row">
                            <div class="col-md-12 mb-30">
                                <label class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Bundles Courses Name') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <div class="label-text-title color-heading font-medium font-16 mb-3">{{ __('Overview') }} <span class="text-danger">*</span></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-30">
                                <label class="label-text-title color-heading font-medium font-16 mb-3">Status <span class="text-danger">*</span></label>
                        ...
                        <div>
                            <a href="{{ route('instructor.bundle-course.index') }}" class="theme-btn theme-button3 quiz-back-btn">{{ __('Back To List') }}</a>
