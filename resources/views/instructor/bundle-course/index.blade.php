                ...
                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                    <div class="card course-item border-0 radius-3 bg-white">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text instructor-name-certificate font-medium text-uppercase font-12">{{ @$bundle->user->instructor->name }}</p>
                            <div class="course-item-bottom">
                                <div class="instructor-bottom-item font-14 font-semi-bold text-uppercase mb-15">{{ __('Courses') }}: <span class="color-hover">{{ @$bundle->bundleCourses->count() }}</span></div>
                                <div class="instructor-bottom-item font-14 font-semi-bold text-uppercase mb-15">{{ __('Price') }}: <span class="color-hover">
