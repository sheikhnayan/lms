                                        ...
                                        <div class="upload-course-item-block course-overview-step1 radius-8">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            ...
                                                            <label class="mr-15"><input type="radio" name="type" value="vimeo" class="lecture-type">  Vimeo</label>
                                                            @endif
                                                            <label class="mr-15"><input type="radio" name="type" value="text" class="lecture-type" id="lectureTypeText"> Text </label>
                                                            <label class="mr-15"><input type="radio" name="type" value="image" class="lecture-type" id="lectureTypeImage"> Image </label>
                                                            <label class="mr-15"><input type="radio" name="type" value="pdf" class="lecture-type" id="lectureTypePDF"> PDF </label>
                                                            <label class="mr-15"><input type="radio" name="type" value="slide_document" class="lecture-type" id="lectureTypePowerpoint"> Slide Document </label>
                                                            <label class="mr-15"><input type="radio" name="type" value="audio" class="lecture-type" id="lectureTypeAudio"> Audio </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div id="imageDiv" class="d-none">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-6 mb-30">
                                                        <p class="font-14 color-gray">Preferable image size: (1MB)</p>
