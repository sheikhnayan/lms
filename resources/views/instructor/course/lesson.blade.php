                                                                        ...
                                                                        <div class="accordion-body">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <a href="{{route('edit.lecture', [$course->uuid, $lesson->uuid, $lecture->uuid])}}"
                                                                                                   ...
                                                                                                   class="upload-course-video-edit-btn upload-course-video-main-edit-btn font-14 color-para font-medium bg-transparent border-0 mx-2"><span
                                                                                                        class="iconify" data-icon="clarity:note-edit-line"></span>Edit</a>
                                                                                                <a href="javascript:void(0);"
                                                                                                   ...
                                                                                                   class="upload-course-video-edit-btn font-14 color-para font-medium bg-transparent border-0 mx-2 delete"><span
                                                                                                        class="iconify" data-icon="ant-design:delete-outlined"></span>Delete</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div class="mt-3 lecture-edit-upload-btn">
                                                                                <a href="{{route('upload.lecture', [$course->uuid, $lesson->uuid])}}"
                                                                                   class="common-upload-video-btn color-heading font-13 font-medium ms-0 mt-4"><span class="iconify"
                                                                                                                                                                     data-icon="feather:upload-cloud"></span>Upload
                                                                                    lesson</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="upload-video-introduction-box">
                                                                ...
                                                                <div class="upload-introduction-title-box d-flex align-items-center justify-content-between">
                                                                    ...
                                                                    <div class="d-flex upload-course-video-6-duration-count">
                                                                        <div class="upload-course-duration-text font-14 color-para font-medium"><span class="iconify"
                                                                                                                                                      data-icon="octicon:device-desktop-24"></span>Video
                                                                            <span class="color-heading">(0)</span></div>
                                                                        <div class="upload-course-duration-text font-14 color-para font-medium"><span class="iconify"
                                                                                                                                                      data-icon="ant-design:clock-circle-outlined"></span>Duration
                                                                            <span class="color-heading">(0)</span></div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="upload-introduction-box-content d-flex align-items-center justify-content-between">
                                                                    <div class="upload-introduction-box-content-left d-flex align-items-center">
                                                                        ...
                                                                        <a href="{{route('upload.lecture', [$course->uuid, $lesson->uuid])}}"
                                                                           class="common-upload-lesson-btn font-13 font-medium"><span class="iconify"
                                                                                                                                      data-icon="feather:upload-cloud"></span>Upload
                                                                            lesson</a>
                                                                    </div>
                                                                    <div class="d-flex">
                                        ...
                                        <form method="POST" action="{{route('lesson.store', [$course->uuid])}}" class="row g-3 needs-validation" novalidate>
                                            ...
                                            <div id="upload-course-video-1">
                                                ...
                                                <div class="upload-course-item-block course-overview-step1 radius-8">
                                                    ...
                                                    <div class="row mb-30">
                                                        <div class="col-md-12">
                                                            <label class="label-text-title color-heading font-medium font-16 mb-3">Section title of the coures “ {{$course->title}}
                                                                ”</label>
