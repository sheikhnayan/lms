            ...
            <div class="row instructor-dashboard-top-part">
                ...
                <div class="col-md-4">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8 mb-30">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{ __('Number of Courses') }}</h6>
                            <h5>{{ $total_courses }}</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8 mb-30">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{ __('Total Enroll') }}</h6>
                            <h5>{{ $total_enroll }}</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8 mb-30">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{ __('Total Earning') }}</h6>
                            <h5>
                ...
                <div class="col-md-4">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8 mb-30">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{ __('Available balance') }}</h6>
                            <h5>
                                @if(get_currency_placement() == 'after')
                ...
                <div class="col-md-4">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8 mb-30">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{ __('Total Withdraw Amount') }}</h6>
                            <h5>
                                @if(get_currency_placement() == 'after')
                ...
                <div class="col-md-4">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8 mb-30">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{ __('Pending Withdraw Amount') }}</h6>
                            <h5>
                                @if(get_currency_placement() == 'after')
                ...
                <div class="col-md-12">
                    <div class="instructor-withdrawal-money-box instructor-dashboard-top-part-item d-flex align-items-center radius-8 mb-30">
                        <div class="flex-grow-1 ms-3">
                            <h6 class="text-white font-11 font-semi-bold text-uppercase mb-2">{{ __('Withdrawal Money') }}</h6>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="withdrawal-modal-title text-center">
                        <p class="font-13 font-medium text-uppercase">{{ __('Available Balance') }}</p>
                        <h4>
                            @if(get_currency_placement() == 'after')
                                {{instructor_available_balance()}} {{ get_currency_symbol() }}
                            @else
