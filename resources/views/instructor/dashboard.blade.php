            ...
            <div class="row instructor-dashboard-top-part instructor-only-dashboard-top-part">
                    ...
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="para-color font-11 font-semi-bold text-uppercase">{{__('Earning')}} <span
                                        class="color-gray font-13 text-capitalize font-normal">({{__('This Month')}})</span></h6>
                            </div>
                ...
                <div class="col-md-4 mb-30">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{__('Total Enroll')}} <span
                                    class="color-gray font-13 text-capitalize font-normal">({{__('This Month')}})</span></h6>
                ...
                <div class="col-md-4 mb-30">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{__('Best Selling Course')}}
                            </h6>
                ...
                <div class="col-lg-12 col-xl-6 mb-30">
                    <div class="recently-added-courses-box radius-8">
                        <div class="recently-added-courses-title d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="{{route('instructor.course')}}" class="bg-transparent color-heading font-11 font-medium text-uppercase">{{ __('View All') }}</a>
                        </div>
                ...
                <div class="col-lg-12 col-xl-6 mb-30">
                    <div class="recently-added-courses-box radius-8">
                        <div class="your-rank-title d-flex justify-content-between align-items-center mb-4">
                            ...
                            <a href="{{ route('instructor.ranking-level') }}" class="bg-transparent color-hover font-11 font-medium text-uppercase">{{__('List of Rank')}}</a>
                        </div>
