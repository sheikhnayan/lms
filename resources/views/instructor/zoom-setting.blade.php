                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-30">
                        ...
                        <select name="status" id="status" class="">
                            ...
                            <option value="1" {{ @$zoom->status == 1 ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ @$zoom->status != 1 ? 'selected' : '' }}>Disable</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-30">
                        ...
                        <select name="host_video" id="host_video" class="">
                            <option value="">{{__('Select Option')}}</option>
                            <option value="1" {{ @$zoom->host_video == 1 ? 'selected' : '' }}>Enable</option>
                            <option value="0" {{ @$zoom->host_video != 1 ? 'selected' : '' }}>Disable</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-30">
                        ...
                        <select name="participant_video" id="participant_video" class="">
                            <option value="">{{__('Select Option')}}</option>
                            <option value="1" {{ @$zoom->participant_video == 1 ? 'selected' : '' }}>Enable</option>
                            <option value="0" {{ @$zoom->participant_video != 1 ? 'selected' : '' }}>Disable</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-30">
                        ...
                        <select name="waiting_room" id="waiting_room" class="">
                            <option value="">{{__('Select Option')}}</option>
                            <option value="1" {{ @$zoom->waiting_room == 1 ? 'selected' : '' }}>Enable</option>
                            <option value="0" {{ @$zoom->waiting_room != 1 ? 'selected' : '' }}>Disable</option>
                        </select>
                    </div>
                </div>
            </div>
