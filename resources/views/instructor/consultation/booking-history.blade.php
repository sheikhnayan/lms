                                                                            ...
                                                                            <div class="row align-items-center">
                                                                                <div class="col-md-9">
                                                                                    <input type="text" name="start_url" class="form-control start_url" id="zoom_start_url{{ $upcoming->id }}"
                                                                                           placeholder="Generate your live class link"
                                                                                ...
                                                                                <div class="row align-items-center">
                                                                                    <div class="col-md-9">
                                                                                        <input type="text" name="moderator_pw" minlength="6" class="form-control " id="moderator_pw_{{ $upcoming->id }}"
                                                                                               placeholder="Type moderator password (min length  6)" value="{{ @$upcoming->moderator_pw }}">
                                                                                ...
                                                                                <div class="row align-items-center">
                                                                                    <div class="col-md-9">
                                                                                        <input type="text" name="attendee_pw" minlength="6" class="form-control" id="attendee_pw_{{ $upcoming->id }}"
                                                                                               placeholder="Type attendee password (min length  6)" value="{{ @$upcoming->attendee_pw }}">
